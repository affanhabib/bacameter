...
class UploadMeter extends StatefulWidget {
  // UploadMeter({Key key, this.nosam}) : super(key: key);
...
class _UploadMeter extends State<UploadMeter> {
  File imageFile;
  ...
  void getCatatan() async {
    ...
    //     "http://10.0.2.2/bacameter_api/getcatatan.php",
    //     body: {"nosambungan": widget.nosam});
    final response =
  ...
  void _cek() async {
    if (stanskrg != null) {
      int lalu = int.parse(widget.stan);
      int skrg = int.parse(stanskrg.text);
  ...
  Future upload(File imageFile) async {
    ...
    // String namaFile = '$date$month-$nosam.jpg';
    String namaFile = '';
    String month = '';
          ...
          children: <Widget>[
            ...
            Align(
              ...
              child: Container(
                ...
                child: FlatButton(
                  onPressed: () {
                    if (3 < DateTime.now().day && DateTime.now().day < 21) {
                      if (stanskrg.text == null ||
                          _valCatatan == null ||
                          imageFile == null) {
                        showDialog(
                            context: context,
